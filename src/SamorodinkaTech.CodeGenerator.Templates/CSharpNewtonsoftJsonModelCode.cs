...
namespace SamorodinkaTech.CodeGenerator.Templates {
    ...
    public partial class CSharpNewtonsoftJsonModelCode : CSharpNewtonsoftJsonModelCodeBase {
...
for (var j=0; j < propertyDescriptionLines.Count; j++)
{
    ...
    if (p.IsRequired) {
            ...
            #line 51 ""
            this.Write(", Required = Required.Always");
    ...
    public class CSharpNewtonsoftJsonModelCodeBase {
